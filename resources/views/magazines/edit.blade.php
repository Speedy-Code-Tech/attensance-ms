@extends('layouts.main', ['title' => 'Edit Magazine'])
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h4 class="card-title">Edit Magazine</h4>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-group-default">
                                        ...
                                        <input type="text" name="title" id="title" class="form-control"
                                            placeholder="ex. Abot Tanaw Issue #01" value="{{ old('title', $magazine->title) }}" required>
                                            @error('title')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-group-default">
                                        ...
                                        <input type="date" name="issue" id="issue" class="form-control"
                                            placeholder="Middle name" value="{{ old('issue', $magazine->issue) }}">
                                            @error('issue')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-group-default">
                                        ...
                                        <input type="file" name="pdf" id="pdf" class="form-control"
                                            placeholder="Last name" value="{{ old('pdf') }}">
                                            <small class="form-text text-muted">Leave empty if you don't want to change the PDF file.</small>
                                            @error('pdf')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                    </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group form-group-default">
                                        ...
                                        <textarea name="description" id="description" class="form-control" rows='3'
                                            placeholder="Write what the magazine is all about..." value="{{ old('description', $magazine->description) }}">
                                        </textarea>
                                            @error('description')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
