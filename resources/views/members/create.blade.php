...
@extends('layouts.main', ['title' => 'Add Member'])

@section('content')
<div class="main-panel">
    <div class="content">
        <div class="page-inner">
            <form action="{{ route('members.store') }}" method="POST" enctype="multipart/form-data" onsubmit="setProfilePictureValue()">
                @csrf
                        ...
                        <div class="row p-3">
                            <div class="col-md-3">
                                <div class="col-md-12 mb-3">
                                    <div id="dp_uploaded">
                                        <img id="profilePicturePreview" src="{{ asset('images/create_hope.jpg') }}" class="img-thumbnail w-100 profilepic" alt="Profile Picture">
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group form-group-default">
                                            ...
                                            <input type="text" name="middle_initial" id="middle_initial" class="form-control"
                                                placeholder="Middle name" value="{{ old('middle_initial') }}">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group form-group-default">
                                            ...
                                            <input type="text" name="mobile_number" id="mobile_number" class="form-control"
                                                placeholder="09xxxxxxxxx" value="{{ old('mobile_number') }}">
                                                @error('mobile_number')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group form-group-default">
                                            ...
                                            <input type="text" name="address" id="address" class="form-control"
                                                placeholder="221B Baker St." value="{{ old('address') }}">
                                                @error('address')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group form-group-default">
                                            ...
                                            <input type="date" name="member_at" id="member_at" class="form-control"
                                                placeholder="Joined At" value="{{ old('member_at') }}">
                                                @error('member_at')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                        </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group form-group-default">
                                            ...
                                            @elseif (auth()->user()->isMember())
                                                <input type="text" name="username" class="form-control" value="{{ old('username') }}" disabled>
                                            @endif
