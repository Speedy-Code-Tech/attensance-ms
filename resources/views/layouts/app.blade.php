                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            ...
                            <a class="nav-link" href="{{ route('attendance.sheet') }}">Attendance Sheet</a>
                            <a class="nav-link" href="{{ route('attendance-logs.index') }}">Attendance Logs</a>
                            <a class="nav-link" href="{{ route('magazines.index') }}">Publication</a>
