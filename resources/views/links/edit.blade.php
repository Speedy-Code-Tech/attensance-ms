@extends('layouts.main', ['title' => 'Edit Link'])
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group form-group-default">
                                            ...
                                            <input type="text" name="title" id="title" class="form-control"
                                                placeholder="ex. Cash Distribution" value="{{ old('title', $link->title) }}" required>
                                                @error('title')
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group form-group-default">
                                            ...
                                            <input type="text" name="url" id="url" class="form-control"
                                                placeholder="ex. Cash Distribution" value="{{ old('url', $link->url) }}" required>
                                                @error('url')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group form-group-default">
                                            ...
                                            <select name="category" class="form-control">
                                                ...
                                                <option value="financial" {{ old('category', $link->category) === 'financial' ? 'selected' : '' }}>Financial</option>
                                            </select>
                                            @error('category')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
